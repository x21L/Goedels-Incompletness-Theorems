...
\subsection{An Informal Approach}
	...
	\begin{itemize}
		...
		\item The status quo is that we have some axioms that are unprovable. Wouldn't it just make sense to add these axioms to our system, that we have a complete system? 
...
\begin{frame}
	...
	\begin{Definition}[$\omega$-consistent]
